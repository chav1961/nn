 ...
 */
public class RegresionEvaluator implements Evaluator<AbstractNeuralNetwork, DataSet<MLDataItem>> {

    @Override
    public EvaluationMetrics evaluate(AbstractNeuralNetwork neuralNet, DataSet<MLDataItem> testSet) {
