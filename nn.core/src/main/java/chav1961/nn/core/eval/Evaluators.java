...
public class Evaluators {
     ...
     */
    public static EvaluationMetrics evaluateRegressor(AbstractNeuralNetwork<?> neuralNet, DataSet<MLDataItem> testSet) {
     ...
     */
    public static EvaluationMetrics evaluateClassifier(AbstractNeuralNetwork<?> neuralNet, DataSet<MLDataItem> testSet) {
